...
let sunVal: HTMLInputElement
sunVal = document.getElementById("sun") as HTMLInputElement

let moonVal: HTMLInputElement
moonVal = document.getElementById("moon") as HTMLInputElement

let risingVal: HTMLInputElement
risingVal = document.getElementById("rising") as HTMLInputElement
// Here, when the value of sun is changed, we will call the method postAndUpdate.
// TODO: Do the same for moon and rising
sunVal.addEventListener('input',() => postAndUpdate())
moonVal.addEventListener('input',() => postAndUpdate())
risingVal.addEventListener('input',() => postAndUpdate())
...
function postAndUpdate(): void {
  ...
  //  HINT: use .innerHTML
  let sunval = sunVal.value
  let moonval = moonVal.value
  let risingval = risingVal.value

  if(sunval === "" || moonval === "" || risingval === ""){return;}
...
document.addEventListener('keyup', (key) => if(key.code == 'Space'){updateValues("Pisces", "Pisces", "Pisces")})
