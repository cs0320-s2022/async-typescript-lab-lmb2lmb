...
let sunVal;
sunVal = document.getElementById("sun");
let moonVal;
moonVal = document.getElementById("moon");
let risingVal;
risingVal = document.getElementById("rising");
...
document.addEventListener('keyup', (key) => { if (key.code == 'Space') {
